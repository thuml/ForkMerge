...
from .tools import download as download_data, check_exits
...
class DomainNet(ImageList):
    ...
    """
    download_list = [
        ("image_list", "image_list.zip", "https://cloud.tsinghua.edu.cn/f/35e5c87d80bc4db0aea5/?dl=1"),
        ...
        # you can use the following links from tsinghua cloud if you have trouble downloading from the original links
